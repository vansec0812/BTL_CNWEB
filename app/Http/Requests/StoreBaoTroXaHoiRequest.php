...
class StoreBaoTroXaHoiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ho_khau_id' => [
                'nullable',
                'integer',
                Rule::exists('ho_khau', 'id')->whereNull('deleted_at')->where('trang_thai', 'hoat_dong'),
            ],
            'nhan_khau_id' => [
                'nullable',
                'integer',
                Rule::exists('nhan_khau', 'id')->whereNull('deleted_at')->where('trang_thai', '!=', 'da_mat'),
            ],
