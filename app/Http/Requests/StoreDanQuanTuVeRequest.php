...
class StoreDanQuanTuVeRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'nhan_khau_id.required_without' => 'Vui lòng chọn ít nhất một công dân.',
            'nhan_khau_ids.required_without' => 'Vui lòng chọn ít nhất một công dân.',
            'nhan_khau_ids.min' => 'Vui lòng chọn ít nhất một công dân.',
