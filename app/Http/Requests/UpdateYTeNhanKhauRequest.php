...
class UpdateYTeNhanKhauRequest extends FormRequest
{
    ...
    {
        $yTeNhanKhau = $this->route('y_te_nhan_khau') ?? $this->route('yTeNhanKhau');
        $yTeNhanKhauId = is_object($yTeNhanKhau) ? $yTeNhanKhau->id : $yTeNhanKhau;
        ...
        return [
            'nhan_khau_id' => [
                ...
                Rule::unique('y_te_nhan_khau', 'nhan_khau_id')->ignore($yTeNhanKhauId),
            ],
