...
class NghiaVuQuanSuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $records = [
            ...
            ['nhan_khau_id' => 9,  'trang_thai_nvqs' => 'xuat_ngu',     'ly_do_tam_hoan' => 'khong_ap_dung', 'ngay_nhap_ngu' => '1990-02-15', 'don_vi_quan_doi' => 'Trung đoàn 5, Sư đoàn 8', 'ngay_xuat_ngu' => '1992-02-15', 'quan_ham_khi_xuat_ngu' => 'Hạ sĩ', 'ket_qua_kham_suc_khoe' => 'loai_1'],
            ['nhan_khau_id' => 11, 'trang_thai_nvqs' => 'xuat_ngu',     'ly_do_tam_hoan' => 'khong_ap_dung', 'ngay_nhap_ngu' => '1993-02-15', 'don_vi_quan_doi' => 'Tiểu đoàn 3', 'ngay_xuat_ngu' => '1995-02-15', 'quan_ham_khi_xuat_ngu' => 'Binh nhì', 'ket_qua_kham_suc_khoe' => 'loai_1'],
