...
class DoanhNghiepSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('doanh_nghiep_ho_kinh_doanh')->insert(array_merge($base, [
            ...
            'dia_chi' => 'Thôn Phủ Quốc, Xã Quốc Oai', 'thon_xom' => 'Thôn Phủ Quốc',
        ...
        DB::table('doanh_nghiep_ho_kinh_doanh')->insert(array_merge($base, [
            ...
            'dia_chi' => 'Lô 5, KCN Quốc Oai, Xã Quốc Oai', 'thon_xom' => 'Thôn Ngô Sài',
        ...
        DB::table('doanh_nghiep_ho_kinh_doanh')->insert(array_merge($base, [
            ...
            'dia_chi' => 'Số 56, Xóm 1, Thôn Hoa Vôi', 'thon_xom' => 'Thôn Hoa Vôi',
        ...
        DB::table('doanh_nghiep_ho_kinh_doanh')->insert(array_merge($base, [
            ...
            'dia_chi' => 'Số 7, Xóm 2, Thôn Du Nghệ', 'thon_xom' => 'Thôn Du Nghệ',
