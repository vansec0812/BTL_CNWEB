    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-6">
                ...
                <select id="loai_chinh_sach" name="loai_chinh_sach" class="form-select @error('loai_chinh_sach') is-invalid @enderror" required>
            ...
            <div class="col-lg-4">
                ...
                <input id="so_quyet_dinh_cong_nhan" name="so_quyet_dinh_cong_nhan" value="{{ old('so_quyet_dinh_cong_nhan', $record?->so_quyet_dinh_cong_nhan) }}" class="form-control @error('so_quyet_dinh_cong_nhan') is-invalid @enderror" maxlength="100">
            ...
            <div class="col-lg-4">
                ...
                <input type="date" id="ngay_cong_nhan" name="ngay_cong_nhan" value="{{ old('ngay_cong_nhan', $record?->ngay_cong_nhan?->format('Y-m-d')) }}" class="form-control @error('ngay_cong_nhan') is-invalid @enderror">
            ...
            <div class="col-lg-4">
                ...
                <input id="co_quan_cap" name="co_quan_cap" value="{{ old('co_quan_cap', $record?->co_quan_cap) }}" class="form-control @error('co_quan_cap') is-invalid @enderror" maxlength="255">
            ...
            <div class="col-lg-4">
                ...
                <input type="number" step="0.01" min="0" max="100" id="ty_le_thuong_tat" name="ty_le_thuong_tat" value="{{ old('ty_le_thuong_tat', $record?->ty_le_thuong_tat) }}" class="form-control @error('ty_le_thuong_tat') is-invalid @enderror">
            ...
            <div class="col-lg-4">
                ...
                <input type="number" min="0" id="muc_tro_cap_hang_thang" name="muc_tro_cap_hang_thang" value="{{ old('muc_tro_cap_hang_thang', $record?->muc_tro_cap_hang_thang) }}" class="form-control @error('muc_tro_cap_hang_thang') is-invalid @enderror">
