            ...
            <div class="card shadow-sm border-0 mb-4 h-100">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="ten_dot" name="ten_dot" value="{{ old('ten_dot') }}" class="form-control" placeholder="Ví dụ: Phát quà Tết Nguyên Đán Ất Tỵ 2025" required>
                    </div>

                    <div class="mb-3">
                        <label for="mo_ta" class="form-label">Mô tả chi tiết</label>
                        <textarea id="mo_ta" name="mo_ta" class="form-control" rows="3" placeholder="Nhập mục đích, thông điệp cứu trợ hoặc thông tin thêm về đợt trợ cấp này...">{{ old('mo_ta') }}</textarea>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" id="gia_tri_quy_doi" name="gia_tri_quy_doi" value="{{ old('gia_tri_quy_doi') }}" class="form-control" min="0" placeholder="Ví dụ: 500000">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="nguon_kinh_phi" class="form-label">Nguồn kinh phí</label>
                        <input type="text" id="nguon_kinh_phi" name="nguon_kinh_phi" value="{{ old('nguon_kinh_phi') }}" class="form-control" placeholder="Ví dụ: Quỹ Vì Người Nghèo xã, ngân sách huyện, Mạnh thường quân tài trợ...">
                    </div>

                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label for="ngay_bat_dau_cap_phat" class="form-label">Ngày bắt đầu cấp phát <span class="text-danger">*</span></label>
                            <input type="date" id="ngay_bat_dau_cap_phat" name="ngay_bat_dau_cap_phat" value="{{ old('ngay_bat_dau_cap_phat', now()->format('Y-m-d')) }}" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label for="ngay_ket_thuc_cap_phat" class="form-label">Ngày kết thúc (Dự kiến)</label>
                            <input type="date" id="ngay_ket_thuc_cap_phat" name="ngay_ket_thuc_cap_phat" value="{{ old('ngay_ket_thuc_cap_phat') }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="mb-0">
                        ...
                        <textarea id="ghi_chu" name="ghi_chu" class="form-control" rows="2" placeholder="Ghi chú nội bộ nếu có...">{{ old('ghi_chu') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
