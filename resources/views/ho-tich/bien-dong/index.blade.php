                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end gap-1">
                                    <a href="{{ route('bien-dong.show', $record) }}" class="btn btn-sm btn-action-view" title="Xem">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    @can('manage_ho_khau')
                                    <a href="{{ route('bien-dong.edit', $record) }}" class="btn btn-sm btn-action-edit" title="Sửa">
