        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" novalidate>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="chuc_vu" id="chuc_vu" class="form-control form-control-sm" value="{{ old('chuc_vu', $user->chuc_vu) }}" placeholder="Ví dụ: Cán bộ địa chính, Trưởng thôn..." style="border-radius: 8px;">
                </div>
