    ...
    <div class="card-body p-4">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="thon_xom" name="thon_xom" value="{{ old('thon_xom', $datDaiTaiSan->thon_xom ?? '') }}">
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="so_gcn_qsdd" name="so_gcn_qsdd" value="{{ old('so_gcn_qsdd', $datDaiTaiSan->so_gcn_qsdd ?? '') }}">
            </div>
            <div class="col-md-4">
                <label for="so_to_ban_do" class="form-label">Số tờ bản đồ</label>
                <input type="text" class="form-control" id="so_to_ban_do" name="so_to_ban_do" value="{{ old('so_to_ban_do', $datDaiTaiSan->so_to_ban_do ?? '') }}">
            </div>
            <div class="col-md-4">
                <label for="so_thua_dat" class="form-label">Số thửa đất</label>
                <input type="text" class="form-control" id="so_thua_dat" name="so_thua_dat" value="{{ old('so_thua_dat', $datDaiTaiSan->so_thua_dat ?? '') }}">
            </div>
            <div class="col-md-4">
                <label for="ngay_cap_gcn" class="form-label">Ngày cấp GCN</label>
                <input type="date" class="form-control" id="ngay_cap_gcn" name="ngay_cap_gcn" value="{{ old('ngay_cap_gcn', isset($datDaiTaiSan->ngay_cap_gcn) ? $datDaiTaiSan->ngay_cap_gcn->format('Y-m-d') : '') }}">
            </div>
            <div class="col-md-4">
                <label for="ngay_het_han_gcn" class="form-label">Ngày hết hạn (Nếu có)</label>
                <input type="date" class="form-control" id="ngay_het_han_gcn" name="ngay_het_han_gcn" value="{{ old('ngay_het_han_gcn', isset($datDaiTaiSan->ngay_het_han_gcn) ? $datDaiTaiSan->ngay_het_han_gcn->format('Y-m-d') : '') }}">
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-6">
                ...
                <select class="form-select" id="loai_dat" name="loai_dat" required>
            ...
            <div class="col-md-6">
                ...
                <input type="number" step="0.01" min="0" class="form-control" id="dien_tich_m2" name="dien_tich_m2" value="{{ old('dien_tich_m2', $datDaiTaiSan->dien_tich_m2 ?? '') }}" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="vi_tri_mo_ta" name="vi_tri_mo_ta" value="{{ old('vi_tri_mo_ta', $datDaiTaiSan->vi_tri_mo_ta ?? '') }}">
            </div>
            <div class="col-12">
                <label for="ghi_chu" class="form-label">Ghi chú</label>
                <textarea class="form-control" id="ghi_chu" name="ghi_chu" rows="2">{{ old('ghi_chu', $datDaiTaiSan->ghi_chu ?? '') }}</textarea>
            </div>
        </div>
    </div>
